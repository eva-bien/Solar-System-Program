...
class QuestionTests(unittest.TestCase):
    ...
    def test_question_with_no_match(self):
        self.validateQuestion("Random planet", "I couldn't find the answer to your question. I can answer questions about one of the following planets: Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus, and Neptune.")
    ...
    def test_multiple_planets_requested(self):
        self.validateQuestion("What are the masses of Earth and Mercury?", "You asked about two or more planets. Please only ask about one planet.")

    # Validating all the test cases for the moon reponses.
    def test_planet_with_zero_moons(self):
        self.validateQuestion("How many moons does Mercury have?", "Mercury has no moons.")

    def test_planet_with_one_moon(self):
        self.validateQuestion("How many moons does Earth have?", "Earth has 1 moon. The moon's name is The Moon.")

    def test_planet_with_multiple_moons(self):
        self.validateQuestion("How many moons does Mars have?", "Mars has 2 moons: Phobos, Deimos.")
    ...
    def test_distance_from_the_sun(self):
        self.validateQuestion("What is the distance from Uranus to the Sun?", "The distance from Uranus and the Sun is between 18.3 - 20.1 AU.")

    def test_distance_from_the_sun_aphelion(self):
        self.validateQuestion("What is the aphelion from Uranus to the Sun?", "The furthest point (aphelion) of Uranus's direct orbit around the Sun is 20.1 AU.")

    def test_distance_from_the_sun_perihelion(self):
        self.validateQuestion("What is the perihelion from Uranus to the Sun?", "The nearest point (perihelion) of Uranus's direct orbit around the Sun is 18.3 AU.")

    # Here are the mass based questions.
    def test_mass_of_planet(self):
        result = "Venus has a mass of 4.86731 x 10^24 kg." 
        self.validateQuestion("What is the mass of Venus?", result)
        self.validateQuestion("How big is Venus?", result)
        self.validateQuestion("What is the size of Venus?", result)
        self.validateQuestion("How heavy is Venus?", result)
        self.validateQuestion("What is the weight of Venus?", result)
        self.validateQuestion("How many kg is Venus?", result)
